...
Version  : 0.6.8
Release  : 14
URL      : https://files.pythonhosted.org/packages/37/cf/d24ca8a8e9d12be8bcea4743b091d89998d4943fff5cd46462e86a248d25/pyroute2.core-0.6.8.tar.gz
Source0  : https://files.pythonhosted.org/packages/37/cf/d24ca8a8e9d12be8bcea4743b091d89998d4943fff5cd46462e86a248d25/pyroute2.core-0.6.8.tar.gz
...
%prep
%setup -q -n pyroute2.core-0.6.8
cd %{_builddir}/pyroute2.core-0.6.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647103439
...
cp %{_builddir}/pyroute2.core-0.6.8/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.core-0.6.8/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/4cc77b90af91e615a64ae04893fdffa7939db84c
