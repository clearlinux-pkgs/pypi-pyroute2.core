...
Version  : 0.6.9
Release  : 15
URL      : https://files.pythonhosted.org/packages/da/22/465aea4e28315972713963b86941d9f9ecaa2883f9d3d4ee3aca5d3403ba/pyroute2.core-0.6.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/da/22/465aea4e28315972713963b86941d9f9ecaa2883f9d3d4ee3aca5d3403ba/pyroute2.core-0.6.9.tar.gz
...
%prep
%setup -q -n pyroute2.core-0.6.9
cd %{_builddir}/pyroute2.core-0.6.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647893558
...
cp %{_builddir}/pyroute2.core-0.6.9/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.core-0.6.9/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/4cc77b90af91e615a64ae04893fdffa7939db84c
