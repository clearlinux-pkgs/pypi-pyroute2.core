...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707134823
...
cp %{_builddir}/pyroute2.core-%{version}/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/cd9bad64b174708395f795bb92f7b4be7d996e8f || :
cp %{_builddir}/pyroute2.core-%{version}/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/4cc77b90af91e615a64ae04893fdffa7939db84c || :
