...
Version  : 0.6.11
Release  : 17
URL      : https://files.pythonhosted.org/packages/ae/f4/9404e796109afbbb5333d3712370fc07c18a198b397abb764e0bfbcfdb74/pyroute2.core-0.6.11.tar.gz
Source0  : https://files.pythonhosted.org/packages/ae/f4/9404e796109afbbb5333d3712370fc07c18a198b397abb764e0bfbcfdb74/pyroute2.core-0.6.11.tar.gz
...
%prep
%setup -q -n pyroute2.core-0.6.11
cd %{_builddir}/pyroute2.core-0.6.11
pushd ..
cp -a pyroute2.core-0.6.11 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654538309
...
cp %{_builddir}/pyroute2.core-0.6.11/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.core-0.6.11/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/4cc77b90af91e615a64ae04893fdffa7939db84c
