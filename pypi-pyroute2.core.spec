...
Version  : 0.6.10
Release  : 16
URL      : https://files.pythonhosted.org/packages/8a/5b/b80eadc67b4b8d5a601208bc5d54898b562f8a3c1e65fd37f43f3c007d75/pyroute2.core-0.6.10.tar.gz
Source0  : https://files.pythonhosted.org/packages/8a/5b/b80eadc67b4b8d5a601208bc5d54898b562f8a3c1e65fd37f43f3c007d75/pyroute2.core-0.6.10.tar.gz
...
%prep
%setup -q -n pyroute2.core-0.6.10
cd %{_builddir}/pyroute2.core-0.6.10
pushd ..
cp -a pyroute2.core-0.6.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654528264
...
cp %{_builddir}/pyroute2.core-0.6.10/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.core-0.6.10/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/4cc77b90af91e615a64ae04893fdffa7939db84c
