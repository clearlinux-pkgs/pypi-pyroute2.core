...
Version  : 0.6.12
Release  : 18
URL      : https://files.pythonhosted.org/packages/7d/d2/85ad6d6f27cf06bd6efcdf43fab3b2e1c18033b303aedef724401eaac325/pyroute2.core-0.6.12.tar.gz
Source0  : https://files.pythonhosted.org/packages/7d/d2/85ad6d6f27cf06bd6efcdf43fab3b2e1c18033b303aedef724401eaac325/pyroute2.core-0.6.12.tar.gz
...
%prep
%setup -q -n pyroute2.core-0.6.12
cd %{_builddir}/pyroute2.core-0.6.12
pushd ..
cp -a pyroute2.core-0.6.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655132926
...
cp %{_builddir}/pyroute2.core-0.6.12/LICENSE.Apache.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/cd9bad64b174708395f795bb92f7b4be7d996e8f
cp %{_builddir}/pyroute2.core-0.6.12/LICENSE.GPL.v2 %{buildroot}/usr/share/package-licenses/pypi-pyroute2.core/4cc77b90af91e615a64ae04893fdffa7939db84c
